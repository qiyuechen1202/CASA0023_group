...
# Heat Risk Assessment in Hong Kong
## Based on the Influence of Heat Island Effect
...
```
---
# Risk & Ethic Considerations
.panelset[
.panel[.panel-name[Risks]
**Risk**
...
**Limitation**
1. Only consider the comprehensive risk level, ignoring the differences under different risk types (hazar-exposure-vulnerability), and do not consider the response measures for the three types of risks respectively;
2. It only proposed the need for more urban greening, but did not give actual suggestions on site selection and location

3. Due to the availability of data, our results are based on the data of 2021, and the research results may have limitations (poor) in timeliness.

4. Surface temperatures may not represent actual temperatures (Chakraborty et al. 2022)

Source: `r Citet(myBib, "Rinkesh2016")`
]

.panel[.panel-name[Ethic & Safety]
**Ethic & Safety**
...
---
# Summary
**Objective**: Mitigate the Urban Heat Island (UHI) effect and reduce socio-economic disparities in Hong Kong through sustainable urban planning and community engagement.

.pull-left[

### Strategies:

Implement green infrastructure and innovative cooling technologies.
Enhance public health and comfort for all, with a focus on vulnerable communities.
Foster community involvement and provide policy recommendations.
]
